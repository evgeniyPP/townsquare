<template>
  ...
  >
    <h3>Выберите персонажей для {{ nonTravelers }} игроков:</h3>
    ...
    <div class="warning" v-if="hasSelectedSetupRoles">
      ...
      <span>
        Внимание: выбраны персонажи, которые меняют подготовку к игре!
        Рандомайзер не учитывает этих персонажей.
      </span>
    </div>
    ...
    <div class="button-group">
      ...
      >
        ...
        Назначить {{ selectedRoles }} персонажей
      </div>
